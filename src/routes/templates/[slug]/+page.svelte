    ...
    <div class="col-span-3">
        <div class="flex justify-between rounded-md mb-5">
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-xl shadow m ml-0">
                <di class="flex">
                    <button type="submit" class="w-18 text-color bg-white border-custom p-2 mr-2 hover:bg-orange-200" on:click={()=>{goto('/templates')}}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M11.25 9l-3 3m0 0l3 3m-3-3h7.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                          
                          </svg>
                    </button>
                    <button type="submit" class="w-18 text-color bg-white border-custom p-2  hover:bg-orange-200" on:click={()=>{goto(`/templates/builder/${data.template}`)}}>
