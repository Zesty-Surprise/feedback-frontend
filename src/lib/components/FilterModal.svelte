                ...
                <div class="pl-16 pt-10 grid grid-cols-2">
                    <div>
                        ...
                        <input
                            ...
                            bind:group={checkedCheckboxes}
                        />
                        <label for="production" class="label-spacing"
                            >Production</label
                        >
                        ...
                        <input
                            ...
                            bind:group={checkedCheckboxes}
                        />
                        <label for="finance" class="label-spacing"
                            >Finance</label
                        >
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            bind:group={checkedCheckboxes}
                        />
                        <label for="innovation" class="label-spacing"
                            >Innovation</label
                        >
                        ...
                        <input
                            ...
                            bind:group={checkedCheckboxes}
                        />
                        <label for="ecommerce" class="label-spacing"
                            >E-commerce</label
                        >
                        ...
                        <input
                            ...
                            bind:group={checkedCheckboxes}
                        />
                        <label for="purchase" class="label-spacing"
                            >Purchase</label
                        >
                    </div>
                </div>
